...
export function GlobalCtaV1(props: GlobalCtaProps) {
  ...
  return (
    <div className={cn("w-full px-0 md:px-4 lg:px-0 mx-auto max-w-7xl", props.className)}>
      <div className="relative overflow-hidden bg-black! py-10 md:py-12 px-6 md:px-12 rounded-none md:rounded-lg flex flex-col md:flex-row items-center justify-between gap-8 shadow-sm">
        ...
        <div className="relative z-10 flex flex-col items-center md:items-start text-center md:text-left max-w-2xl">
          <h2 className="text-white text-2xl md:text-[28px] font-semibold tracking-tight leading-snug mb-2">
            {title}
          </h2>
        ...
        <div className="relative z-10 shrink-0">
          <Button 
            className="bg-white hover:bg-white/95 text-neutral-900 font-semibold rounded-lg h-11 px-6 text-sm shadow-xs transition-colors duration-200 cursor-pointer" 
            asChild
          >
