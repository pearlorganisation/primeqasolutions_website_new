...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    meta_data: Schema.Attribute.Component<'seo.meta-data', false> &
      Schema.Attribute.Required;
    page_section: Schema.Attribute.DynamicZone<
      [
        'block.service-hero',
        'block.client-strip',
        'block.trust-building-block',
        'block.service-block',
        'block.feature-block',
        'block.benifits-block',
        'block.tech-stack-block',
        'block.pricing-block',
        'block.cta-block',
        'block.faq-block',
        'block.cta-button-block',
        'block.automation-process',
        'block.products-block',
        'block.team-block',
        'block.offer-block',
        'block.split-block',
        'block.heading-block',
        'block.office-gallery-block',
        'block.clutch-widget-block',
        'block.case-study-block',
        'block.industry-block',
      ]
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiBecomeAPartnerBecomeAPartner
  ...
  collectionName: 'become_a_partner';
  info: {
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    FAQs: Schema.Attribute.Component<'widget.accordion', false> &
      Schema.Attribute.Required;
...
export interface ApiCareerCareer extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    meta_data: Schema.Attribute.Component<'seo.meta-data', false>;
    publishedAt: Schema.Attribute.DateTime;
    section_hero: Schema.Attribute.Component<'block.service-hero', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiContactFormContactForm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    how_we_can_help: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
  ...
  attributes: {
    ...
    page_section: Schema.Attribute.DynamicZone<
      [
        ...
        'block.clutch-widget-block',
        'block.clients-logo',
        'block.client-success-block',
        'block.client-strip',
        'block.case-study-block',
        'block.blog-block',
        'block.benifits-block',
        'block.automation-process',
        'block.ai-advantage-block',
      ]
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiEngagementModelsEngagementModels
  extends Struct.SingleTypeSchema {
  collectionName: 'engagement_models';
  info: {
    displayName: 'Engagement Models';
    pluralName: 'engagement-models-plural';
    singularName: 'engagement-models';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::engagement-models.engagement-models'
    > &
      Schema.Attribute.Private;
    meta_data: Schema.Attribute.Component<'seo.meta-data', false> &
      Schema.Attribute.Required;
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta_button: Schema.Attribute.Component<'block.button', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::header.header'
    ...
    menu_items: Schema.Attribute.Component<'links.nav-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    top_bar: Schema.Attribute.Component<'utils.top-bar', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHireQaEngineerHireQaEngineer
  extends Struct.CollectionTypeSchema {
  collectionName: 'hire_qa_engineers';
  info: {
    displayName: 'Hire QA Engineer';
    pluralName: 'hire-qa-engineers';
    singularName: 'hire-qa-engineer';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::hire-qa-engineer.hire-qa-engineer'
    > &
      Schema.Attribute.Private;
    meta_data: Schema.Attribute.Component<'seo.meta-data', false> &
      Schema.Attribute.Required;
...
export interface ApiJobListJobList extends Struct.CollectionTypeSchema {
  collectionName: 'job_lists';
  info: {
    displayName: 'Job List';
    pluralName: 'job-lists';
    singularName: 'job-list';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    job_type: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::job-list.job-list'
    > &
      Schema.Attribute.Private;
...
export interface ApiLegalLegal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::legal.legal'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publish_at: Schema.Attribute.Date & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiLifeAtPrimeqaLifeAtPrimeqa extends Struct.SingleTypeSchema {
  collectionName: 'life_at_primeqas';
  info: {
    displayName: 'Life at PrimeQA';
    pluralName: 'life-at-primeqas';
    singularName: 'life-at-primeqa';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::life-at-primeqa.life-at-primeqa'
    > &
      Schema.Attribute.Private;
    meta_data: Schema.Attribute.Component<'seo.meta-data', false> &
      Schema.Attribute.Required;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Central registry for all products';
    displayName: 'Product';
    pluralName: 'products';
...
export interface ApiSocialPlatformSocialPlatform
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_social_profiles: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-social-profile.user-social-profile'
    >;
  };
}
...
export interface ApiUserSocialProfileUserSocialProfile
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_social_profiles';
  info: {
    displayName: 'User Social Profile';
    pluralName: 'user-social-profiles';
    singularName: 'user-social-profile';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiWhomWeWorkWithWhomWeWorkWith
  extends Struct.SingleTypeSchema {
  collectionName: 'whom_we_work_withs';
  info: {
    displayName: 'Whom We Work With';
    pluralName: 'whom-we-work-withs';
    singularName: 'whom-we-work-with';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::whom-we-work-with.whom-we-work-with'
    > &
      Schema.Attribute.Private;
    meta_data: Schema.Attribute.Component<'seo.meta-data', false> &
      Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::engagement-models.engagement-models': ApiEngagementModelsEngagementModels;
      'api::footer.footer': ApiFooterFooter;
      'api::header.header': ApiHeaderHeader;
      'api::hire-qa-engineer.hire-qa-engineer': ApiHireQaEngineerHireQaEngineer;
      'api::home.home': ApiHomeHome;
      'api::industry.industry': ApiIndustryIndustry;
      'api::job-list.job-list': ApiJobListJobList;
      'api::keyword.keyword': ApiKeywordKeyword;
      'api::legal.legal': ApiLegalLegal;
      'api::life-at-primeqa.life-at-primeqa': ApiLifeAtPrimeqaLifeAtPrimeqa;
      'api::product-page.product-page': ApiProductPageProductPage;
      'api::product.product': ApiProductProduct;
      'api::service.service': ApiServiceService;
      'api::social-platform.social-platform': ApiSocialPlatformSocialPlatform;
      'api::tag.tag': ApiTagTag;
      'api::user-social-profile.user-social-profile': ApiUserSocialProfileUserSocialProfile;
      'api::whom-we-work-with.whom-we-work-with': ApiWhomWeWorkWithWhomWeWorkWith;
